    ...
    <div className="w-full min-h-[calc(100vh-80px)] grid grid-cols-12 gap-x-3 px-3 items-center">
      <div className="w-full col-start-2 col-end-12 2xl:col-start-3 2xl:col-end-11 flex flex-col-reverse lg:flex-row justify-between">
        ...
        <div className="pt-14 lg:pr-8 w-full">
          ...
          <h2 className="font-extrabold text-5xl md:text-6xl bg-linear-to-r from-[#9810fa] to-[#d396ff] bg-clip-text text-transparent mt-4 mb-8">
            React Food
          </h2>
          <p className="max-w-2xl text-white">
            Những món ăn ngon tuyệt vời được chuẩn bị tươi mới mỗi ngày!
          </p>
          <p className="max-w-xl 2xl:max-w-2xl text-white">
          ...
          <button
            ...
            className="mt-12 lg:mt-20 mb-6 px-4 py-2 font-semibold bg-[#9810fa] text-white rounded-tl-[10px] rounded-br-[10px] rounded-tr-sm rounded-bl-sm hover:cursor-pointer hover:opacity-80 duration-200"
          >
            Menu <ArrowRight className="inline-block ml-2" />
          </button>
          {/* Mạng xã hội */}
          <div className="flex flex-row gap-4 mb-8">
            <div className="p-2 rounded-full border-2 hover:bg-black text-white duration-300">
              <Facebook size={22} />
            </div>
            <div className="p-2 rounded-full border-2 hover:bg-black text-white duration-300">
              <Instagram size={22} />
