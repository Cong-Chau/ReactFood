...
function Home() {
  return (
    <div className="w-full grid grid-cols-12 gap-x-3 px-3 items-center">
      <div className="w-full col-start-2 col-end-12 flex flex-row justify-between">
        {/* Bên trái */}
        <div className="pt-34">
          ...
          <button className="mt-20 mb-6 px-4 py-2 font-semibold bg-[#101A24] text-white rounded-tl-[10px] rounded-br-[10px] rounded-tr-sm rounded-bl-sm hover:cursor-pointer hover:opacity-80 duration-200">
